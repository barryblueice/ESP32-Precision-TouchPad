...
const uint8_t ptp_hid_report_descriptor[] = {
   ...
   0x65, 0x11,                          // UNIT (Centimeter)
    ...
    // -------- Haptic Configuration TLC --------
    0x05, 0x0E,                         // USAGE_PAGE (Haptics)
    0x09, 0x01,                         // USAGE (Touchpad Haptic Feedback)
    0xA1, 0x01,                         // COLLECTION (Application)
    0x85, REPORTID_HAPTIC_FEATURE,      // REPORT_ID (Haptic Feature Report)
    
    0x09, 0x20,                         // USAGE (Haptic Intensity)
    0x15, 0x00,                         // LOGICAL_MINIMUM (0)
